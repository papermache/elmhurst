...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<sassc>, [">= 2.0.0"])
      s.add_runtime_dependency(%q<autoprefixer-rails>, [">= 5.2.1"])
      s.add_development_dependency(%q<minitest>, ["~> 5.11"])
      s.add_development_dependency(%q<minitest-reporters>, ["~> 1.3"])
      s.add_development_dependency(%q<capybara>, ["~> 3.6"])
      s.add_development_dependency(%q<poltergeist>, [">= 0"])
      s.add_development_dependency(%q<sassc-rails>, [">= 2.0.0"])
      ...
      s.add_dependency(%q<sassc>, [">= 2.0.0"])
      s.add_dependency(%q<autoprefixer-rails>, [">= 5.2.1"])
      s.add_dependency(%q<minitest>, ["~> 5.11"])
      s.add_dependency(%q<minitest-reporters>, ["~> 1.3"])
      s.add_dependency(%q<capybara>, ["~> 3.6"])
      s.add_dependency(%q<poltergeist>, [">= 0"])
      s.add_dependency(%q<sassc-rails>, [">= 2.0.0"])
