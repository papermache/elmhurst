...
For detailed installation, usage and API instructions, please refer to the DataTables web-pages: https://www.datatables.net

Questions, feature requests and bug reports (etc) can all be asked on the DataTables forums: https://www.datatables.net/forums/
